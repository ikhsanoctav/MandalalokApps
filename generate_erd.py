...
data = json.dumps({"graph": dot_content}).encode("utf-8")
req = urllib.request.Request("https://quickchart.io/graphviz", data=data, headers={"Content-Type": "application/json"})
try:
    with urllib.request.urlopen(req) as response:
        with open("/home/aeropro/.gemini/antigravity-ide/brain/0088e856-0f2b-4f9e-aac0-cc300a868e0d/erd_mandalaloka.svg", "wb") as f:
