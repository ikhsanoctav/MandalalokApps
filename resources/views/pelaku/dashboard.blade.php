                                                            ...
                                                            <div class="relative bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl text-center border border-white/20" @click.outside="showQr = false">
                                                                ...
                                                                <div class="mt-8">
                                                                    <button onclick="printQrDirect('{{ route('pelaku.umkm.print-qr', $umkm->id_umkm) }}', this)"
                                                                        class="inline-flex items-center gap-2 px-8 py-3.5 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-200 hover:-translate-y-1 w-full justify-center text-lg mb-3">
                                                                        <i class="mdi mdi-qrcode text-xl"></i> Cetak Stiker QR
                                                                    </button>
