...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
        <a href="{{ route('superadmin.pelatihan.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium inline-flex items-center gap-1 mb-2">
    ...
    <div class="flex items-center gap-2">
        <a href="{{ route('superadmin.pelatihan.edit', $pelatihan->id) }}" class="btn-primary inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-white rounded-xl transition-all">
...
<div class="bg-white/90 backdrop-blur-sm shadow-sm rounded-3xl border overflow-hidden">
    <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <form action="{{ route('superadmin.pelatihan.register_user', $pelatihan->id) }}" method="POST" class="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
            @csrf
            ...
            <tbody class="divide-y divide-slate-100 text-sm">
                ...
                <tr>
                    <td class="p-4">
                        ...
                        <div class="text-slate-700 text-xs">{{ $p->user->name }}</div>
                    </td>
                    <td class="p-4">
                ...
                @empty
                <tr>
                    <td colspan="5" class="p-8 text-center text-slate-700">
