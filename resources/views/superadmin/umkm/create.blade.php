...
@section('content')
    <div class="w-full space-y-8 pb-12">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-700 mt-1 font-medium">Lengkapi formulir di bawah ini untuk mendaftarkan data UMKM baru.</p>
                </div>
            </div>
            <a href="{{ route('superadmin.umkm') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white border-2 border-slate-200 hover:border-indigo-300 hover:text-indigo-600 text-slate-700 font-bold rounded-lg transition-all shadow-sm">
        ...
        <form action="{{ route('superadmin.umkm.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 relative">
            @csrf
            ...
            <div class="sticky bottom-4 z-50 mt-10">
                <div class="bg-slate-900/90 backdrop-blur-xl p-4 sm:px-8 sm:py-5 rounded-[2rem] shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4 border border-slate-700">
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto justify-end">
                        <a href="{{ route('superadmin.umkm') }}" class="px-6 py-3.5 bg-slate-800 text-slate-300 hover:text-white font-bold rounded-xl transition-colors hover:bg-slate-700">Batal</a>
