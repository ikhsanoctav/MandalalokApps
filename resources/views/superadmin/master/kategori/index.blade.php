            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm text-left border border-slate-200 rounded-md">
                    ...
                    <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                ...
                                <td class="py-3 px-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('superadmin.kategori.destroy', $kategori->id) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-10 text-center text-slate-400">Belum ada data kategori.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <x-modal name="importModal" maxWidth="lg">
        <form action="{{ route('superadmin.kategori.import') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 rounded-t-lg">
                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Import Data Kategori</h3>
                <div class="mt-4 mb-4">
