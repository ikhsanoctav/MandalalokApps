...
@section('breadcrumb', 'Master Data / Kelurahan / Tambah')

@section('content')
    <div class="max-w-2xl mx-auto space-y-6">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-slate-800">Tambah Kelurahan</h2>
        ...
        <x-card>
            <form action="{{ route('superadmin.kelurahan.store') }}" method="POST">
                @csrf
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Kode Kelurahan <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="kode_kelurahan" value="{{ old('kode_kelurahan') }}" required
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Nama Kelurahan <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="nama_kelurahan" value="{{ old('nama_kelurahan') }}" required
                            class="w-full border-slate-300 rounded-lg p-2.5 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_rw" value="{{ old('jumlah_rw') }}" min="1" max="100"
                            class="w-full border-slate-300 rounded-lg p-2.5 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Biarkan kosong jika belum ada">
                        <p class="text-[10px] text-slate-500 mt-1">*Sistem akan meng-generate nomor RW otomatis (001, 002,
