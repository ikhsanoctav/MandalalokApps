                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                ...
                                <td class="py-3 px-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('superadmin.kelurahan.destroy', $kel->id) }}" method="POST"
                                            class="inline-block"
                                            onsubmit="return confirm('Yakin ingin menghapus kelurahan ini?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
    ...
    <x-modal name="importModal" maxWidth="lg">
        <form action="{{ route('superadmin.kelurahan.import') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 rounded-t-lg">
                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Import Data Kelurahan</h3>
                <div class="mt-4 mb-4">
