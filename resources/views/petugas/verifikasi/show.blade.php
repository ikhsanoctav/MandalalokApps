    ...
    <div class="space-y-6 max-w-5xl mx-auto">
        <div class="flex items-center justify-between">
            <div>
                ...
                <a href="{{ route('operator.verifikasi.index') }}" class="text-sm text-slate-500 hover:text-slate-700 flex items-center gap-1 mt-1">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5 space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-500">{{ $umkm->kategori->nama_kategori ?? '-' }}</p>
                        </div>
                        <div>
                            ...
                            <p class="text-sm text-slate-500">RT {{ $umkm->pemilik->rt ?? '-' }} / RW {{ $umkm->pemilik->rw ?? '-' }}</p>
                        </div>
                        <div>
                    ...
                    <div class="p-6">
                        @if($umkm->verifikasiLapangan->isEmpty())
                            <div class="text-center py-12">
                                ...
                                <p class="text-slate-500 text-sm mb-6">UMKM ini belum pernah dikunjungi untuk verifikasi lapangan.</p>
                                    ...
                                    <div class="relative pl-6">
                                        ...
                                        <div class="bg-slate-50 rounded-xl p-5 border border-slate-100">
                                            <div class="flex flex-wrap items-start justify-between gap-4 mb-3">
                                                <div>
                                                    <div class="flex items-center gap-2 mb-1">
                                                        ...
                                                        <span class="text-xs text-slate-500">Oleh: {{ $verifikasi->petugas->name ?? 'Unknown' }}</span>
                                                    </div>
                                            ...
                                            @if($verifikasi->latitude_kunjungan && $verifikasi->longitude_kunjungan)
                                                <div class="mt-4 flex items-center gap-2 text-xs text-slate-500 bg-slate-100/50 p-2 rounded-md inline-flex">
