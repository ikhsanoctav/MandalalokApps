...
@section('breadcrumb', 'Daftar UMKM Baru')
...
@section('content')
    <div class="w-full space-y-8 pb-12">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 mt-1 font-medium">Lengkapi formulir di bawah ini untuk mendaftarkan data UMKM baru.</p>
                </div>
            </div>
            <a href="{{ route('admin.umkm.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white border-2 border-slate-200 hover:border-indigo-300 hover:text-indigo-600 text-slate-700 font-bold rounded-lg transition-all shadow-sm">
        ...
        <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 relative">
            @csrf
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-xl shadow-slate-200/50 border border-white/80 overflow-hidden relative">
                ...
                <div class="px-8 pt-8 pb-6 border-b border-slate-100 relative z-10 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 font-medium mt-1">Jika NIK sudah terdaftar, data pemilik akan dihubungkan otomatis.</p>
                    </div>
                </div>
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nik" value="{{ old('nik') }}" required maxlength="16" placeholder="Masukkan 16 digit NIK"
                    ...
                    <div>
                        ...
                        <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Contoh: Bandung"
                            class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 block p-4 transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email_pemilik" value="{{ old('email_pemilik') }}" placeholder="email@contoh.com"
                            class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 block p-4 transition-all">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat_pemilik" required rows="2" placeholder="Nama Jalan, Nomor Rumah, dll"
                            class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 block p-4 transition-all resize-none">{{ old('alamat_pemilik') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-xl shadow-slate-200/50 border border-white/80 overflow-hidden relative">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama_usaha" value="{{ old('nama_usaha') }}" required placeholder="Contoh: Warung Makan Budi"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="status_usaha"
                                ...
                                <option value="non_aktif" {{ old('status_usaha') == 'non_aktif' ? 'selected' : '' }}>Non Aktif</option>
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun_berdiri" value="{{ old('tahun_berdiri') }}" placeholder="Contoh: 2021" min="1900" max="{{ date('Y') }}"
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-slate-100 pt-8 mt-4">
                        <div>
                            ...
                            <input type="text" name="no_izin_usaha" value="{{ old('no_izin_usaha') }}" placeholder="Nomor Izin"
                        ...
                        <div>
                            ...
                            <input type="text" name="npwp_usaha" value="{{ old('npwp_usaha') }}" placeholder="Format: 12.345..."
                                class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-teal-500/20 focus:border-teal-500 block p-4 transition-all">
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">Telepon Usaha</label>
                            <input type="text" name="telp_usaha" value="{{ old('telp_usaha') }}" placeholder="022-123456"
                                class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-teal-500/20 focus:border-teal-500 block p-4 transition-all">
                        </div>
                    ...
                    <div class="md:col-span-2 border-t border-slate-100 pt-8 mt-4">
                        ...
                        <textarea name="alamat_usaha" required rows="2" placeholder="Nama Jalan, Blok, RT/RW..."
                            class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 block p-4 transition-all resize-none">{{ old('alamat_usaha') }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Latitude</label>
                                <input type="text" id="latitude" name="latitude" value="{{ old('latitude', '-6.914744') }}" readonly class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 bg-slate-50 text-slate-600 text-sm font-mono focus:outline-none">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Longitude</label>
                                <input type="text" id="longitude" name="longitude" value="{{ old('longitude', '107.609810') }}" readonly class="w-full px-4 py-3 rounded-xl border-2 border-slate-200 bg-slate-50 text-slate-600 text-sm font-mono focus:outline-none">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi" rows="4" placeholder="Ceritakan tentang keunggulan, produk utama, atau sejarah singkat..."
                            class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 block p-4 transition-all resize-none">{{ old('deskripsi') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-xl shadow-slate-200/50 border border-white/80 overflow-hidden relative">
                ...
                <div class="p-8 grid grid-cols-1 sm:grid-cols-3 gap-8 relative z-10">
                    ...
                    <div>
                        ...
                        <input type="number" name="tenaga_kerja_laki" value="{{ old('tenaga_kerja_laki', 0) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="tenaga_kerja_perempuan" value="{{ old('tenaga_kerja_perempuan', 0) }}" min="0"
                            class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-bold text-lg rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 block p-4 transition-all">
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-xl shadow-slate-200/50 border border-white/80 overflow-hidden relative">
                    ...
                    <div class="p-8 relative z-10">
                        ...
                        <textarea name="riwayat_bantuan" rows="5" placeholder="Contoh: BPUM 2021, Bantuan Alat 2022... (Kosongkan jika belum pernah)"
                            class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-cyan-500/20 focus:border-cyan-500 block p-4 transition-all resize-none">{{ old('riwayat_bantuan') }}</textarea>
                    </div>
                </div>
                    ...
                    <div class="p-8 relative z-10 space-y-4">
                        <div>
                            <div class="relative">
                                ...
                                <input type="text" name="media_sosial[facebook]" value="{{ old('media_sosial.facebook') }}" placeholder="Username Facebook"
                        ...
                        <div>
                            <div class="relative">
                                ...
                                <input type="text" name="media_sosial[instagram]" value="{{ old('media_sosial.instagram') }}" placeholder="Username Instagram"
                                    class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 block p-3.5 pl-12 transition-all">
                            </div>
                        </div>
                        <div>
                            <div class="relative">
                                ...
                                <input type="text" name="media_sosial[tiktok]" value="{{ old('media_sosial.tiktok') }}" placeholder="Username TikTok"
                                    class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 block p-3.5 pl-12 transition-all">
                            </div>
                        </div>
                        <div>
                            <div class="relative">
                                ...
                                <input type="text" name="media_sosial[whatsapp]" value="{{ old('media_sosial.whatsapp') }}" placeholder="No WhatsApp Bisnis"
                                    class="w-full bg-slate-50 hover:bg-white border-2 border-slate-200 text-slate-800 font-medium text-base rounded-xl focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 block p-3.5 pl-12 transition-all">
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-xl shadow-slate-200/50 border border-white/80 overflow-hidden relative">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mb-4 font-medium">Foto ini akan ditampilkan sebagai sampul usaha di e-katalog.</p>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mb-4 font-medium">Bisa pilih banyak foto sekaligus. Maks 5MB per foto.</p>
                        ...
                        <label for="foto_gallery" class="flex flex-col items-center justify-center w-full h-48 border-2 border-pink-300 border-dashed rounded-2xl cursor-pointer hover:border-pink-500 hover:bg-pink-50/50 bg-slate-50 transition-all group overflow-hidden relative">
                            <div class="text-center group-hover:scale-110 transition-transform duration-300">
                                ...
                                <p id="galleryCount" class="text-xs text-slate-500 mt-1 font-medium">Belum ada foto dipilih</p>
                            </div>
            ...
            <div class="sticky bottom-4 z-50 mt-10">
                <div class="bg-slate-900/90 backdrop-blur-xl p-4 sm:px-8 sm:py-5 rounded-[2rem] shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4 border border-slate-700">
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto justify-end">
                        <a href="{{ route('admin.umkm.index') }}" class="px-6 py-3.5 bg-slate-800 text-slate-300 hover:text-white font-bold rounded-xl transition-colors hover:bg-slate-700">Batal</a>
                        <button type="submit" name="action" value="simpan" class="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-black rounded-xl transition-all shadow-lg shadow-indigo-500/30 hover:-translate-y-1 hover:shadow-indigo-500/50 flex items-center justify-center gap-2">
                            <i class="mdi mdi-content-save-outline text-xl"></i> Simpan Data UMKM Baru
                        </button>
                    </div>
                </div>
            </div>
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                var initialLat = {{ old('latitude', -6.914744) }};
                var initialLng = {{ old('longitude', 107.609810) }};
                var zoomLevel = 13;
