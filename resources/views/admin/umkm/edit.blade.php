...
@section('content')
    <div class="w-full space-y-8 pb-12">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 mt-1 font-medium">Perbarui informasi pemilik dan profil usaha UMKM.</p>
                </div>
            </div>
        ...
        <form action="{{ route('admin.umkm.update', $umkm->id_umkm) }}" method="POST" enctype="multipart/form-data" class="space-y-8 relative">
            @csrf
            @method('PUT')
