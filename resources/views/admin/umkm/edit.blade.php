...
@section('content')
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.umkm.index') }}" class="text-sm text-blue-600 hover:underline flex items-center gap-1">
        ...
        <form action="{{ route('admin.umkm.update', $umkm->id_umkm) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
