...
@section('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <a href="{{ route('admin.pengajuan', ['status' => 'proses']) }}"
            ...
            <a href="{{ route('admin.pengajuan', ['status' => 'disetujui']) }}"
            ...
            <a href="{{ route('admin.pengajuan', ['status' => 'ditolak']) }}"
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white rounded-2xl shadow-sm border border-slate-200 p-5 md:p-6 mb-1">
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">Kelola data pengajuan bantuan dan pembiayaan UMKM</p>
            </div>
        ...
        <form method="GET" action="{{ route('admin.pengajuan') }}" id="filterForm">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div id="table-container">
                @include('admin.pengajuan.table-data')
            </div>
        </div>
    </div>
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-slate-100 animate-fade-in-up">
                <div class="bg-slate-50 px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">Daftarkan bantuan atau pembiayaan baru untuk UMKM</p>
                    </div>
    ...
    <script>
        ...
        // Fix pagination and ajax load routes
        ...
        `;
            ...
            // Fetch dynamic modal HTML from endpoint - adapted to admin route
            fetch(`/admin/pengajuan/${id}/modal`)
                .then(res => res.text())
                .then(html => {
        ...
        function submitStatusUpdate() {
            ...
            setTimeout(() => {
                // Fetch to admin route status update endpoint
                fetch(`/admin/pengajuan/${activePengajuanId}/status`, {
                        method: 'POST',
                        headers: {
