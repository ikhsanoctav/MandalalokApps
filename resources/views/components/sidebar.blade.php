...
<aside
    class="hidden md:block fixed inset-y-0 left-0 h-screen bg-gradient-to-b from-slate-950 to-[#0B1021] text-slate-300 z-[99] shadow-xl transition-all duration-300 flex flex-col"
    ...
    <div class="relative px-4 py-5 border-b border-white/5 flex items-center justify-between">
        ...
        <button @click="toggleSidebar()"
            class="absolute -right-4 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full p-[1.5px] bg-gradient-to-tr from-blue-500 via-indigo-500 to-cyan-400 transition-all duration-300 hover:scale-115 hover:shadow-[0_0_25px_rgba(59,130,246,0.7)] focus:outline-none z-[100] group">
            <div
