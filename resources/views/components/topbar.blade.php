        ...
        <div class="mobile-topbar-actions flex items-center justify-end gap-1 md:gap-4 flex-shrink-0">
                    ...
                    <template x-if="totalUnread > 0">
                        <div class="p-3 border-t border-slate-100 bg-slate-50 text-center">
                            <button @click="markAllAsRead"
                                class="w-full text-xs font-semibold text-blue-600 hover:text-blue-800 transition-colors flex items-center justify-center gap-1 py-1">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>
                                Tandai Semua Riwayat Dibaca
                            </button>
                        </div>
                    </template>
                </div>
            ...
            <div class="relative" x-data="{ open: false }" @click.away="open = false">
                ...
                <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="px-5 py-4 bg-gradient-to-br from-slate-50 to-white border-b border-slate-100">
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Masuk sebagai
                        </p>
                    ...
                    <div class="p-2">
                        <a href="{{ route('profile.edit') }}"
                            class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-600 rounded-md hover:bg-slate-50 hover:text-blue-600 transition-colors group">
                            <div
                                class="bg-slate-100 p-1.5 rounded-2xl group-hover:bg-blue-100 group-hover:text-blue-600 transition-colors">
                    ...
                    <div class="p-2 border-t border-slate-100">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-red-600 rounded-md hover:bg-red-50 w-full transition-colors group">
                                <div class="bg-red-50 p-1.5 rounded-2xl group-hover:bg-red-100 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
