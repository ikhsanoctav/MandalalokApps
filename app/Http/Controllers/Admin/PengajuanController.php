...
class PengajuanController extends Controller
{
    ...
    public function pengajuan(Request $request)
    {
        ...
        if ($request->ajax()) {
            $html = view('admin.pengajuan.table-data', compact('pengajuans'))->render();

            return response()->json(['success' => true, 'html' => $html]);
        }

        return view('admin.pengajuan.index', compact('pengajuans', 'kelurahans', 'stats', 'umkms'));
    }
    ...
    public function pengajuanModal($id)
    {
        ...
        return view('admin.pengajuan.modal-detail', compact('pengajuan'));
    }
